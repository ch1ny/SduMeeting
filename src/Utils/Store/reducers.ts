...
function setNowWebrtcFriendId(state = null, action: { type: string, nowWebrtcFriendId: number | null }) {
...
function updateAvailableVideoDevices(state = new Array(), action: { type: string, devices: DeviceInfo[] }): Array<DeviceInfo> {
    switch (action.type) {
...
function updateAvailableAudioDevices(state = new Array(), action: { type: string, devices: DeviceInfo[] }): Array<DeviceInfo> {
    switch (action.type) {
...
function setUnreadMessages(state = {}, action: { type: string, payload: any })
    : {
...
function setCallStatus(state = CALL_STATUS_FREE, action: { type: string, status: ChatWebSocketType }) {
