				...
				<div id='mainBody' ref={this.mainBodyRef}>
					<div id='header'>
						<div id='titleBar'>
							...
							<button
								...
								title='最小化'
								onClick={() => {
									this.electron.ipcRenderer.send('MINIMIZE_LOGIN_WINDOW');
								}}>
								<MinimizeIcon />
							</button>
							<button
								className='titleBtn'
								id='switch'
								title={this.state.showRegister ? '返回登录' : '注册账号'}
								onClick={() => {
									this.rotateTable();
								}}>
								<RegisterIcon />
					...
					<div className='main'>
						<div
							className='form'
							id='loginForm'
							style={{ display: this.state.showRegister ? 'none' : 'block' }}>
							<div>
								<Input
	...
	<Icon
		component={() => (
			<svg viewBox='0 0 1024 1024' width='1em' height='1em'>
				<path
					d='M704.034133 261.905067l253.354667 253.354666a110.8992 110.8992 0 0 1 0 156.842667l-83.421867 83.421867a8.533333 8.533333 0 0 1-12.066133 0l-162.696533-162.7136-170.8544 170.871466-163.242667-163.089066a8.533333 8.533333 0 0 1-0.989867-10.888534l0.989867-1.194666 164.7616-164.5056 162.0992-162.0992a8.533333 8.533333 0 0 1 12.066133 0z m-384.068266 0a8.533333 8.533333 0 0 1 12.066133 0l161.8432 161.8432-331.776 331.776a8.533333 8.533333 0 0 1-10.888533 0.9728l-1.194667-0.9728-83.4048-83.421867a110.8992 110.8992 0 0 1 0-156.842667z'
					fill='currentColor'
				/>
			</svg>
		)}
