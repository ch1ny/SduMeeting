			...
			<div id='content'>
				...
				<div className='module'>
					...
					<div style={{ fontWeight: 'bolder' }}>
						...
						<p className='p'>
							山大会议用户：指注册、登录、使用山大会议软件及服务并获得管理权限的个人（“个人用户”）或组织（“企业用户”）。
						</p>
						<p className='p'>
							最终用户：指由企业用户为其开通山大会议服务，或被企业用户邀请加入企业组织，使用山大会议的个人或个人用户。
						</p>
						<p className='p'>
							前述“山大会议会议用户”及“最终用户”统称为“用户”或“所有用户”，在本协议中更多地称为“您”。
						</p>
					</div>
				</div>
				<div className='module'>
							...
							<li>
								...
								<div>
									<strong>
										...
										<p>
											7.1.2
											用户须确认，在用户完成注册程序或以其他山大会议允许的方式实际使用本服务时，个人用户应当是具备完全民事行为能力的自然人，如不具备完全民事行为能力，则应征得监护人的明确同意后方能注册成为本服务的个人用户；企业用户应当是合法成立并有效存续的组织，且拥有签署本协议并履行本协议项下义务所需的权利和权限。若用户不具备前述主体资格，请勿使用本服务，否则用户及用户的监护人应承担因此而导致的一切后果，且山大会议有权注销、暂时冻结或永久冻结用户的账户，给山大会议开发组造成损失的，山大会议开发组有权向用户及相关用户的监护人追偿。
										</p>
									</strong>
								</div>
							</li>
							<li>
								...
								<div>
									<strong>
										...
										<p className='p'>
											(3)
											如果您停止使用本软件和/或本服务（如注销您的帐号时），或因您违反法律法规或本协议而被取消或终止本服务，山大会议有权从服务器上永久地删除您的数据，如您为企业用户，山大会议还有权删除您的管理员帐号及您的最终用户基于与您的关系所产生的一切信息和权益。您的服务停止、终止或取消后，山大会议没有义务向您返还任何数据，您应自行在服务停止、终止或取消前做好备份。
										</p>
									</strong>
								</div>
							</li>
